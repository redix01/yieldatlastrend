    ...
    <div className="px-4 py-5 space-y-4 animate-in fade-in slide-in-from-right-4 duration-500">
      <header className="space-y-2">
        ...
        <h2 className="text-xl font-bold text-white">
          {isMarketView ? 'Stock Market' : `Ready to trade, ${user?.name ?? 'Trader'}?`}
        </h2>
        <p className="text-xs text-zinc-500 font-medium">
          {isMarketView
            ? 'Focused stock listing with quick filters and trading access.'
      ...
      {isMarketView ? (
        ...
        <div className="bg-[#0f0f0f] border border-white/5 rounded-2xl p-6 relative overflow-hidden group">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Trade stocks & forex</h3>
