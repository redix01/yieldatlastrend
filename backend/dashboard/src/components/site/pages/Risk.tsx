...
const riskSections: RiskSection[] = [
  {
    title: 'Market Risk',
    detail:
      'Stocks, forex and related assets can move significantly within short periods due to liquidity changes, macro events, or abrupt sentiment shifts.',
    examples: [
  ...
  },
  {
    ...
    examples: [
      ...
      'Tax reporting changes on securities and forex transactions',
    ],
    mitigations: [
        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-8 items-center">
          <div className="space-y-4">
            ...
            <p className="text-slate-300 leading-relaxed">
              Last updated: February 24, 2026. Trading stocks, forex and leveraged products involves substantial risk.
