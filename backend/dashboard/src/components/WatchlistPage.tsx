...
const WatchlistPage: React.FC<WatchlistPageProps> = ({ onBack, onAssetClick }) => {
  ...
  const [activeFilter, setActiveFilter] = useState<'stock' | 'all'>('stock');
    ...
    <div className="px-4 py-6 space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
      <header className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 font-medium">Use the list below to add stocks to your watchlist.</p>
        </div>
      </header>
