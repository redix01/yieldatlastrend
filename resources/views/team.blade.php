@extends('layouts.tradez', ['pageTitle' => 'Our Team'])
                ...
                <div class="col-12 breadcrumb-area ">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item ms-2 ps-7 active" aria-current="page"><span>Team</span></li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row gy-6">
                ...
                <div class="col-12 mt-10 mt-lg-15  d-flex justify-content-center">
                    <a href="#" class="cmn-btn py-2 py-lg-3 px-4 px-lg-6 gap-2 gap-lg-3 align-items-center"> View More</a>
                </div>
            </div>
        </div>
    </section>
